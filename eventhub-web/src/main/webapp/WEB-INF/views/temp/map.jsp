...
<head>
  ...
  <link href="${contextPath}/resources/build/css/style.css" rel="stylesheet">
  ...
  <!--[if lt IE 9]>
        <script src="${contextPath}/resources/assets/js/ie8-responsive-file-warning.js"></script>
        <![endif]-->
...
<body class="nav-md">
  ...
  <script src="${contextPath}/resources/build/js/new-custom.js"></script>
